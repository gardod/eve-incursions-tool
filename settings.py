...
ADMINS = (
	('Andrej Tratnik', 'andtrat@gmail.com'),
)
MANAGERS = ADMINS
...
if ON_OPENSHIFT:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'links',  # Or path to database file if using sqlite3.
...
# Set if host requires authentication
EMAIL_HOST_USER = 'andrej@tratnik.net'
EMAIL_HOST_PASSWORD = 'Slovenija9'

EMAIL_SUBJECT_PREFIX = '[Links] '
